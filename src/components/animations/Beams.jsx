...
const Beams = ({
  ...
  return (
    <Canvas dpr={[1, 2]} frameloop="always" gl={{ alpha: transparent }} style={{ position: 'absolute', inset: 0, ...style }}>
      <group rotation={[0, 0, DegToRad(rotation)]} scale={groupScale}>
      ...
      <PerspectiveCamera makeDefault position={[0, 0, cameraDistance]} fov={cameraFov} />
    </Canvas>
  );
};
